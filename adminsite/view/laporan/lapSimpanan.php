...
<script type="text/javascript">
	$(function() {
		...
		$( "#tgl_akhir" ).datepicker({
            ...
            <div id="toolbar-box">
				<div class='pagetitle icon-48-article'><h2>Laporan Simpanan</h2></div>
				<div class="clr"></div>
			</div>
			<div id="element-box">
               	<div class="width-100 fltlft">
                	<center>
                    <form id="laporan" name="laporan" action="lapSimpananPdf.php" target="_blank" method="post">
                    ...
                    <tbody>
						...
						<tr>
                            ...
                            <td colspan="2">
	                            <select id="anggota" name="anggota">
	                            	...
	                            	<?php 
	                            	$anggota = mysql_query("SELECT * FROM tbl_anggota ORDER BY anggota_id");
	                            	while ($ag = mysql_fetch_array($anggota)) {
		                            	echo "<option value='$ag[anggota_id]'>$ag[anggota_id] - $ag[anggota_nama]</option>";
	                            	}
	                            	?>
	                            </select>
							</td>
						...
						<tr>
                        	<td align="right" class="blue">Jenis Laporan :</td>
                            <td colspan="2">
	                            <input id="tipe" name="tipe" type="radio" value="rekap" checked /> Rekap &nbsp; 
	                            <!--<input id="tipe" name="tipe" type="radio" value="perbulan" /> Per Bulan &nbsp; /--> 
							</td>
						</tr> 
                        <tr>
