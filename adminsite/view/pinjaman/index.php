...
?>
	<section id="main" class="column">
    	<article class="module-menu width_full">
	    	...
	    	<!--<a id="dialogue" class="menu" href="setJasaPinjam.php"> Setting Jasa Pinjaman</a>/-->
		</article>
		...
		<?php } else { ?>
            ...
            <div class="module_content">
				...
				<table class="adminlist" width="100%">
					<thead><tr>
						<th class="nowrap" colspan="13">DATA PINJAMAN</th>
					</tr>
					<tr>
						<th class="nowrap" width="10%">Kode Pinjaman</th>
						<th class="nowrap" width="10%">Kode Anggota</th>
						...
						<th class="nowrap" width="10%">Masuk</th>
						<th class="nowrap" width="10%">Sisa Angsuran</th>
                        <th class="nowrap" width="5%" colspan="4">#</th>
					</tr></thead>
					<tfoot><tr>
						<td colspan="13">
							<div class="container">
                    ...
                    <?php
					if($num==0){
						echo "<tr class='row'><td align='center' colspan='12'><font color='red'><br>Tidak ada data pinjaman.<br><br></font></td></tr>";
					}else{
						$no=1;
						while($row_d=mysql_fetch_array($sql)){
							echo "
							...
							<td align='center'>
								<a id='dialogue' href='addPinjaman.php?do=update&id=$row_d[pinjaman_id]' title='lihat/ubah data pinjaman'>
									<img src='../../images/edit.png 'height='20'/></a>
							</td>
							<td align='center'>
								<a href='../../controller/doPinjaman.php?mod=pinjaman&id=$row_d[pinjaman_id]' title='hapus data pinjaman' 
